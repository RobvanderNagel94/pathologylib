...
# 10-20 non-referenced
MONTAGE_1020 = array([FP2, F8, T4, T6, O2, F4, C4, P4, FZ, CZ, PZ, F3, C3, P3, FP1, F7, T3, T5, O1])
# source referenced
MONTAGE_G19 = array([FP2, F8, FP1, F7, F4, F3, T4, T3, C4, C3, T6, T5, P4, P3, O2, O1, FZ, CZ, PZ])
...
# reference montage
MONTAGE_REF = array([FP2, F8, T4, T6, O2, F4, C4, P4, FZ, CZ, PZ, F3, C3, P3, FP1, F7, T3, T5, O1])
