def test_cwt_with_example():
    ...
    from features.frequency.generator_wavelet import generate_cwt_features
    agg_mode = None
    continuous_wavelet = "morl"
    cwt_features = generate_cwt_features(crops=weighted_crops, wavelet=continuous_wavelet,
                                         fs=fs, band_limits=band_limits, agg_func=agg_mode)
