...
def instantaneous_phases(band_signals: np.ndarray, axis: int) -> np.ndarray:
    """
...
def phase_locking_values(inst_phases: np.ndarray) -> np.ndarray:
    """
...
def phase_locking_value2(theta1: np.ndarray, theta2: np.ndarray) -> np.ndarray:
    """
